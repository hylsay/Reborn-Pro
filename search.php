...
echo "<div class='cat_group category content-container clear-float'><h2><i class='fa fa-search' aria-hidden='true'></i>".get_search_query()."</h2>";	while( have_posts() ){	the_post();	switch (get_option('all_posts_display_type')) {	case 'list':
